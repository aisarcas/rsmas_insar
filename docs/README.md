...
```
#### 4.3.1.trouble about "BadZipFile": 
```
...
#### 4.3.2. trouble abou "walltime ... exceeded limit": 
```
...
#### 4.3.3.trouble about "PyAPS ZeroDivisionError"
```
...
path of ifgrams stored should check [default path](./auto_path.py)